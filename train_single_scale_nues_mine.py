...
from lib.neus import singlescalegrid_neus_mine #, singlescalegrid_neus_mine_w_bg
...
def train(args, cfg, data_dict):
    ...
    model = singlescalegrid_neus_mine.SingleScaleNeUS(xyz_min, xyz_max, resolution=resolution, **model_kwargs)
    ...
    for global_step in trange(1 + start, 1 + cfg_train.N_iters):
        ...
        #     pout = render_result['transmittance'].clamp(1e-6, 1 - 1e-6)
...
if __name__ == '__main__':
    ...
    if args.render_test or args.render_train or args.render_video or args.extract_mesh:
        ...
        model = utils.load_model(singlescalegrid_neus_mine.SingleScaleNeUS, ckpt_path).to(device)
